<template>
  <div>
    ...
    <div class="product_image_area">
      <div class="container">
        <div class="row s_product_inner" style="background: #ffffff;">
          <div class="col-lg-6">
            <div class="s_product_img">
              <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                <ol class="carousel-indicators">
                  <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active">
                    <img class="img-target" :src="product.thumbnail" alt />
                  </li>
                  <li data-target="#carouselExampleIndicators" data-slide-to="1">
                    <img class="img-target" :src="product.picture_1" />
                  </li>
                  <li data-target="#carouselExampleIndicators" data-slide-to="2">
                    <img class="img-target" :src="product.picture_2" alt />
                  </li>
                </ol>
              ...
              <ul class="list">
                ...
                <li>
                  <a href="#">
                    ...
                    <span v-if="product.available === true">In Stock</span>
